		...
		return (
			<div className={twMerge('flex space-x-4 pb-1 text-sm', borderStyle)}>
				...
				<TextareaAutosize
					ref={ref}
					className={twMerge(
						'leading-16 block w-3/5 rounded-lg border-0 bg-gray-800 bg-transparent bg-opacity-50 px-2 py-2  text-sm text-white placeholder-gray-500 shadow-none transition-all focus:ring-0 sm:text-sm',
						className,
					)}
					{...rest}
				/>
